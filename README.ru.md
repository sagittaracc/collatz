...
Давайте проведем аналогию между числами и Harut-системами.

(H, …)<sub>4n+1</sub> представляет число A, такое что A mod 4 = 1.

(H, …)<sub>8n+2</sub> представляет число B, такое что B mod 4 = 2.
