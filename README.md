...
**Conjecture 2**: It is not necessary to perform the splitting, as it is sufficient to prove that the function `kx + 1` for odd k eventually results in a power of two.
